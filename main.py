...
class Clockwork:
    ...
    def sec_hand(self):
        py.draw.line(self.screen,self.color,(self.x,self.y),(self.x2,self.y2),1)
    ...
    def minute_hand(self):
        py.draw.line(self.screen,self.color,(self.x,self.y),(self.x3,self.y3),2)
    ...
    def hour_hand(self):
        py.draw.line(self.screen,self.color,(self.x,self.y),(self.x4,self.y4),3)
